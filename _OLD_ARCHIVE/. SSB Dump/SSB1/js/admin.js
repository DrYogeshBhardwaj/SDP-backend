...
function loadDashboardData() {
    ...
    // Process in reverse to keep LATEST updated record if duplicates exist? 
    // Or normally? Let's keep the FIRST one we see if we iterate normally, 
    // but usually user wants the "latest" one. 
    // Actually, simpler: just keep the first one found in the list (usually oldest/original).
    // If double entry was added recently, it's at the end.
